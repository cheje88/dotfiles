return {
 ...
 ╚═╝  ╚═╝ ╚═════╝ ╚══════╝╚═╝  ╚═╝ 
        ...
        terminal = {
          command = "ascii-image-converter ~/Dropbox/logo.png -C -c",
          random = 10,
          pane = 2,
        },
      },
    ...
    animate = { enabled = true, duration = 160, easing = "sine", fps = 120 },
    ...
    image = {
      ...
      convert = {
        ...
        magick = {
          ...
          -- default = { "{src}[0]", "-scale", "1280x720>" }, -- default for raster images
  ...
  keys = {
    ...
    },
    {
      "<leader>of",
      function()
        require("snacks.picker").pick("obsidian") -- buscar notas
      end,
      desc = "Buscar notas en Obsidian",
    },
    {
      "<leader>on",
      "<cmd>Obsidian new<cr>",
