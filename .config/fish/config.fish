...
set FZF_DEFAULT_OPTS "--style full  --preview 'fzf-preview.sh {}' --bind 'focus:transform-header:file --brief {}'"
...
alias dic='sdcv'
alias wiki='wiki-tui'
alias Txa="cp ~/Dropbox/Latex/articulo.tex"
...
# pnpm
set -gx PNPM_HOME "/home/rush/.local/share/pnpm"
